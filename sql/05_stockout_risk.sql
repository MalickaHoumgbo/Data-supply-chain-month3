...
from  projected_stock_flow;


/* niveaux 2 et 3 combinés pour réperer les produits à niveau crituqe de stock.*/

-- on reunit à nouveaux les CTE précédentes pour qu'elles soient executés dans uen requete principale unique
with  recent_inventory as(
     select sku_id,
       warehouse_id,
       date as snapshot_date,
...
from projected_stock_flow as psf
join recent_inventory as rc on  psf.sku_id = rc.sku_id
